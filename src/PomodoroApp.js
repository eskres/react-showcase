        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="form-floating mb-3 text-light">
              <input type="number" className="form-control" id="taskTime" name="task" value={inputs.task} onChange={handleChange} min={5} max={1440} required></input>
              <label htmlFor="taskTime">Task time (mins)</label>
            </div>
            <div className="form-floating text-light">
              <input type="number" className="form-control" id="breakTime" name="break" value={inputs.break} onChange={handleChange} min={1} max={480} required></input>
  ...
  return (
    ...
    <div className='row row-cols-auto gx-2'>
      ...
      <div className='col d-flex align-items-center'>
        <button className='btn btn-outline-light' data-bs-toggle="modal" data-bs-target="#settings">
